    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>$520.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<a href="#"><span class="ion-ios-star-outline"></span></a>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>$155.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<a href="#"><span class="ion-ios-star-outline"></span></a>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							 <div class="pricing">
		    						<p class="price">Our laptops Collection</p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<a href="#"><span class="ion-ios-star-outline"></span></a>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>Our TV's Collections</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<a href="#"><span class="ion-ios-star-outline"></span></a>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>Our Cameras Collections</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<a href="#"><span class="ion-ios-star-outline"></span></a>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>Our Refrigerators Collections</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<a href="#"><span class="ion-ios-star-outline"></span></a>
...
>>>>>>> 0f103c1b5664acd0f3233d095ebbc50fe1730fce
                    </div>
                </div>
            </div>
        </div>
